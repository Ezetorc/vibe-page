  ...
  return (
    ...
    >
      <img
        ...
        className='mobile:col-[1] mobile:row-[1] desktop:col-auto justify-self-center mobile:ml-[25%] desktop:row-auto rounded-full desktop:w-[clamp(40px,5vw,60px)] mobile:w-[clamp(40px,20vw,60px)] aspect-square bg-orange-crayola'
        src={props.postData.user.imageUrl ?? 'src/assets/images/guest_user.jpg'}
        alt='Profile'
      />

      <Username className='mobile:text-center desktop:text-left desktop:pl-[10px] mobile:text-[clamp(18px,1rem,30px)] desktop:text-[clamp(20px,1.8rem,40px)] desktop:col-auto desktop:row-auto mobile:col-span-2 mobile:row-[2]'>
