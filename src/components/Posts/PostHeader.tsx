...
export function PostHeader (props: {
  ...
  return (
    ...
    >
      ...
      <Username className='mobile:text-center desktop:text-left desktop:pl-[10px] mobile:text-[clamp(15px,0.9rem,25px)] desktop:text-[clamp(20px,1.8rem,21px)] desktop:col-auto desktop:row-auto mobile:col-span-2 mobile:row-[2]'>
